...
<head>
    ...
    <link rel="stylesheet" href="{{ get_url('static', filename = 'bootstrap-select.min.css'       ) }}">
    <script type="text/javascript" src="{{ get_url('static', filename = 'bootstrap.js') }}" charset="utf-8"></script>
    <script type="text/javascript" src="{{ get_url('static', filename = 'bootstrap-select.min.js') }}" charset="utf-8"></script>
